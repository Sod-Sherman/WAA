...
public class DispatcherServlet extends HttpServlet {
	...
	Map<String, mum.edu.framework.ControllerMethod> handlerMethods = new HashMap<String, mum.edu.framework.ControllerMethod>();
    ...
    public void init( ) throws ServletException {
      ...
      mum.edu.framework.ConfigureServlet loadServletProperties = new ConfigureServlet();
    ...
    private void process(HttpServletRequest request,
		...
		System.out.println("controller = " + controller);
 		...
 		mum.edu.framework.ControllerMethod controllerMethod = handlerMethods.get(action);
 ...
 */
 ...
 private void domainDataBinding(HttpServletRequest request, ControllerMethod controllerMethod) {
